...
type AdminTabType = "users" | "coordinators" | "audit-logs" | "maintenance" | "reports" | "travel-history" | "fuel-management" | "platform-settings";
...
const NAV_GROUPS = [
    {
        ...
        items: [
            ...
            { id: "coordinators" as AdminTabType, label: "Coordinators", icon: Shield },
        ],
    },
    {
        label: "Operations",
        items: [
            { id: "maintenance" as AdminTabType, label: "Maintenance", icon: Wrench },
            { id: "travel-history" as AdminTabType, label: "Travel History", icon: MapPin },
            { id: "fuel-management" as AdminTabType, label: "Fuel", icon: Fuel },
        ],
    },
    {
        label: "System",
        items: [
            { id: "audit-logs" as AdminTabType, label: "Audit Logs", icon: ScrollText },
            { id: "reports" as AdminTabType, label: "Reports", icon: FileText },
            { id: "platform-settings" as AdminTabType, label: "Settings", icon: Settings },
        ],
    },
];
...
export default function AdminSidebar({ activeTab, setActiveTab, user, mobileOpen, setMobileOpen }: AdminSidebarProps) {
    ...
    const handleNav = (tab: AdminTabType) => {
        setActiveTab(tab);
        setMobileOpen(false);
    };
